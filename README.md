...
Settings → Data & backup emits backup v1, including media history, link groups, and equivalence audit logs. Restore validates the complete file before one Room transaction. See [backup format v1](docs/backup-format-v1.md).
